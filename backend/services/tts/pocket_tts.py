...
POCKET_VOICES = [
    Voice(id="alba",           name="Alba (F)",          language="en", gender="female",
          description="Warm, conversational English",
          metadata={"preview_text": "Hey, I'm Alba. I tell stories the way a good friend does — slow enough to land, lively enough to pull you in."}),
    Voice(id="anna",           name="Anna (F)",          language="en", gender="female",
          description="Clear, articulate English",
          metadata={"preview_text": "Hi, I'm Anna. Crisp, clear, and easy to follow — the kind of voice that turns a complicated idea into something you actually remember."}),
    Voice(id="azelma",         name="Azelma (F)",        language="en", gender="female",
          description="Expressive, theatrical English",
          metadata={"preview_text": "I'm Azelma — and I never let a sentence land the same way twice. If your script needs feeling, drama, a little fire, that's where I shine."}),
    Voice(id="bill_boerst",    name="Bill (M)",          language="en", gender="male",
          description="Steady, trustworthy English",
          metadata={"preview_text": "I'm Bill. Steady, grounded, and the kind of narrator who makes a long audiobook feel like a Sunday drive — easy, unhurried, dependable."}),
    Voice(id="caro_davy",      name="Caro (F)",          language="en", gender="female",
          description="Bright, friendly English",
          metadata={"preview_text": "I'm Caro. Bright, friendly, a little curious about everything — perfect for explainers, podcasts, or anything that should feel approachable."}),
    Voice(id="charles",        name="Charles (M)",       language="en", gender="male",
          description="Refined British English",
          metadata={"preview_text": "Charles here. There's a bit of London in every syllable — refined, considered, and quite at home reading you the news, a novel, or a particularly elegant footnote."}),
    Voice(id="cosette",        name="Cosette (F)",       language="en", gender="female",
          description="Light, casual English",
          metadata={"preview_text": "Hey, I'm Cosette. Casual, light on its feet — like texting your friend, but out loud."}),
    Voice(id="eponine",        name="Eponine (F)",       language="en", gender="female",
          description="Soft, melancholic English",
          metadata={"preview_text": "I'm Eponine. Soft-spoken, a little wistful — the voice you reach for when the story has weight and you want every word to feel it."}),
    Voice(id="eve",            name="Eve (F)",           language="en", gender="female",
          description="Calm, measured English",
          metadata={"preview_text": "I'm Eve. Calm, measured, never in a hurry — the kind of voice that makes meditation apps work and bedtime stories actually do their job."}),
    Voice(id="fantine",        name="Fantine (F)",       language="en", gender="female",
          description="Earnest, emotional English",
          metadata={"preview_text": "Fantine speaking. I bring honesty — the kind of voice that doesn't perform, it just tells the truth and lets you sit with it."}),
    Voice(id="george",         name="George (M)",        language="en", gender="male",
          description="Confident, polished English",
          metadata={"preview_text": "I'm George. Confident, well-paced, polished without being plastic — you'll hear me on a corporate explainer, and you won't reach for the skip button."}),
    Voice(id="jane",           name="Jane (F)",          language="en", gender="female",
          description="Crisp, professional English",
          metadata={"preview_text": "I'm Jane. Crisp, professional, the kind of voice that makes a tutorial sound like advice from someone who's done it a thousand times."}),
    Voice(id="javert",         name="Javert (M)",        language="en", gender="male",
          description="Stern, commanding English",
          metadata={"preview_text": "Javert. I read with weight and certainty — when a script demands authority, gravity, the gravelly assurance of a man who never wavers, that's me."}),
    Voice(id="jean",           name="Jean (M)",          language="en", gender="male",
          description="Warm, fatherly English",
          metadata={"preview_text": "I'm Jean. Warm, weathered, a little like the uncle who knows how every story ends but tells it anyway because the telling is the point."}),
    Voice(id="marius",         name="Marius (M)",        language="en", gender="male",
          description="Earnest, youthful English",
          metadata={"preview_text": "Marius — earnest, a touch romantic, and very good at meaning what I say. If your line needs heart, hand it to me."}),
    Voice(id="mary",           name="Mary (F)",          language="en", gender="female",
          description="Gentle, classic English",
          metadata={"preview_text": "I'm Mary. Gentle, classic, the voice you hear on the audiobooks your grandmother kept on her nightstand — patient, lovely, never rushed."}),
    Voice(id="michael",        name="Michael (M)",       language="en", gender="male",
    ...
    Voice(id="paul",           name="Paul (M)",          language="en", gender="male",
          description="Easy-going, conversational",
          metadata={"preview_text": "Hey, I'm Paul. Easy-going, conversational — the voice you'd cast for a coffee-shop advertisement or a podcast that should feel like a conversation."}),
    Voice(id="peter_yearsley", name="Peter (M)",         language="en", gender="male",
          description="Cultured, literary English",
          metadata={"preview_text": "I'm Peter. There's a library in my voice — slow turns of phrase, careful emphasis, the patience of a man who would rather be understood than be quick."}),
    Voice(id="stuart_bell",    name="Stuart (M)",        language="en", gender="male",
          description="Wry, dry English",
          metadata={"preview_text": "Stuart, here. Dry, a touch wry, the kind of delivery that lands a punchline without ever announcing it."}),
    Voice(id="vera",           name="Vera (F)",          language="en", gender="female",
          description="Bold, declarative English",
          metadata={"preview_text": "I'm Vera. Bold, declarative, a voice that fills the room when it needs to. If your line is meant to be heard, I'll make sure of it."}),
    Voice(id="estelle",        name="Estelle (F, FR)",   language="fr", gender="female",
          description="Élégante, française",
          metadata={"preview_text": "Je suis Estelle. Une voix française, posée et élégante — celle d'un soir de pluie à Paris, d'un livre qu'on lit à voix basse."}),
    Voice(id="giovanni",       name="Giovanni (M, IT)",  language="it", gender="male",
          description="Caloroso, italiano",
          metadata={"preview_text": "Sono Giovanni. Una voce italiana, calda e piena di musica — fatta per le storie che meritano di essere raccontate piano."}),
    Voice(id="juergen",        name="Jürgen (M, DE)",    language="de", gender="male",
          description="Klar, deutsch",
          metadata={"preview_text": "Ich bin Jürgen. Klar, präzise, und doch nicht steif — eine deutsche Stimme, die erklärt und dabei nicht belehrt."}),
    Voice(id="lola",           name="Lola (F, ES)",      language="es", gender="female",
          description="Cálida, española",
          metadata={"preview_text": "Soy Lola. Una voz española con luz y calidez — para las historias que se sienten como un café en una tarde sin prisa."}),
    Voice(id="rafael",         name="Rafael (M, PT)",    language="pt", gender="male",
          description="Tranquilo, português",
          metadata={"preview_text": "Eu sou o Rafael. Uma voz portuguesa, calma e clara — feita para as histórias que se contam devagar, sem pressa."}),
]
...
class PocketTTS(BaseTTS, VoiceCloningMixin):
    ...
    async def initialize(self) -> None:
        ...
        try:
            ...
            raise RuntimeError(
                "pocket-tts package not installed. Run:\n"
                "    uv add pocket-tts"
            )
        ...
        self.logger.info(
            f"Pocket TTS ready — sample_rate={self._model.sample_rate}Hz, "
            f"default_voice={self._default_voice}"
        )
    ...
    async def synthesize(
        ...
        **kwargs,
        ...
        self.logger.debug(
            f"[PocketTTS] synth '{text[:50]}' → {duration:.2f}s @{sr}Hz voice={voice_id}"
        )
        return TTSResult(
            audio=samples,
            sample_rate=sr,
