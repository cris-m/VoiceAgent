...
class MusicGenerateRequest(BaseModel):
    ...
    duration: float = Field(
        default=30.0, ge=5.0, le=180.0, description="Generated audio duration in seconds"
    )
    tempo: Optional[int] = Field(
        default=None, ge=40, le=240, description="Optional BPM for tempo-aware generation"
    )
