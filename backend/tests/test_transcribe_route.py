...
async def test_transcribe_valid_wav_returns_transcript(
    ...
    mock_voice_pipeline.stt.transcribe = AsyncMock(
...
@pytest.mark.asyncio
async def test_transcribe_returns_language_field(async_client: AsyncClient, mock_voice_pipeline, mock_agent_client):
    from services.stt.base import STTResult
...
@pytest.mark.asyncio
async def test_transcribe_long_audio_calls_chunker(async_client: AsyncClient, mock_voice_pipeline, mock_agent_client):
